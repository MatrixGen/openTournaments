...
const chatService = {
  ...
  // Add these methods to your existing chatService object in chatService.js

  // In the chatService object, add:

  // Channel Management
  deleteChannel: async (channelId) => {
    const response = await chatApi.delete(`/channels/${channelId}`);
    return response.data;
  },

  inviteUsers: async (channelId, userIds) => {
    const response = await chatApi.post(`/channels/${channelId}/invite`, {
      userIds,
    });
    return response.data;
  },
  ...
  editMessage: async (messageId, content) => {
    const response = await chatApi.put(`/messages/${messageId}/edit`, {
      content,
    });
    return response.data;
  },
  ...
  toggleReaction: async (messageId, emoji) => {
    const response = await chatApi.post(`/messages/${messageId}/react`, {
      emoji,
    });
    return response.data;
  },
