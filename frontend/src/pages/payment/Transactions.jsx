...
const TransactionItem = ({
  ...
  const isStuck =
    isPending && new Date() - new Date(created_at) > 5 * 60 * 1000;
      ...
      <div className="p-3 md:p-4">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-start space-x-3 flex-1 min-w-0">
            <div
              className={`p-2 rounded-lg ${getPaymentStatusBgColor(
                status
              )} flex-shrink-0`}
            >
              <BanknotesIcon
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-2 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 gap-2 mb-2">
                ...
                <div className="md:col-span-2 lg:col-span-1">
                  ...
                  <p className="text-sm text-gray-900 dark:text-gray-900 dark:text-white">
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-neutral-700">
            <div className="flex items-center justify-between text-xs md:text-sm">
              <div className="truncate">
                ...
                <span className="ml-1 text-gray-900 dark:text-gray-900 dark:text-white">
                  {formatCurrency(balance_before, "USD")}
                </span>
              </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className={`p-1.5 md:p-2 rounded-lg ${stat.color}`}>
              <stat.icon
                className={`h-4 w-4 md:h-5 md:w-5 ${stat.iconColor}`}
              />
            </div>
            {stat.change !== null && (
              <span
          ...
          <div>
            <p className="text-lg md:text-2xl font-bold text-gray-900 dark:text-gray-900 dark:text-white truncate">
              {stat.value}
            </p>
...
export default function Transactions() {
  ...
  const handleCancelWithdrawal = async (orderReference) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(
          `unexpected error occur while cancelling transaction ${orderReference}`
        );
      }
    } catch {
  ...
  const stuckCount = useMemo(() => {
    return transactions.filter((t) => {
      const isPending = ["pending", "processing", "initiated"].includes(
        t.status
      );
      const isStuck =
        isPending && new Date() - new Date(t.created_at) > 5 * 60 * 1000;
      return isStuck;
    }).length;
  }, [transactions]);
      ...
      <main className="mx-auto max-w-7xl py-4 md:py-8 px-3 sm:px-4 lg:px-8">
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <ArrowPathIcon
                  className={`h-4 w-4 md:h-4 md:w-4 mr-1 md:mr-2 ${
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-900 dark:text-white">
                  Select All Pending
                </h4>
        ...
        <div className="mt-8 space-y-6 md:space-y-0 md:grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-xl p-4 md:p-6 border border-gray-200 dark:border-neutral-700">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1.5">
              <li>
                <strong>Pending too long:</strong> Reconcile to check status
              </li>
              <li>
                <strong>Status mismatch:</strong> Gateway differs from local
              </li>
              <li>
                <strong>Missing transactions:</strong> Check filters and refresh
              </li>
              <li>
                <strong>Balance not updated:</strong> Contact support
              </li>
            </ul>
          </div>
        </div>
              ...
              {selectedTransaction && (
                <div className="px-4 md:px-6 py-4 space-y-4">
                  ...
                  <div className="md:hidden space-y-3">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`p-3 rounded-xl ${getPaymentStatusBgColor(
                          selectedTransaction.status
                        )}`}
                      >
                        <BanknotesIcon
                          className={`h-8 w-8 ${getPaymentStatusColor(
                            selectedTransaction.status
                          )}`}
                        />
                      </div>
                  ...
                  <div className="hidden md:block space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="p-3 bg-gray-100 dark:bg-neutral-700/50 rounded-lg">
                          <p className="text-xs text-gray500 dark:text-gray-400">
                            Updated At
                          </p>
                          <p className="text-sm text-gray-900 dark:text-gray-900 dark:text-white">
