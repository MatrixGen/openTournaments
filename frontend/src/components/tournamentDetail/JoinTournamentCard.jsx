      ...
      <div className="md:hidden">
        <div className="mb-4 space-y-3">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-900 dark:text-white">
              {formatMoney(user.wallet_balance || 0, tournamentCurrency)}
            </span>
          </div>
          {!hasSufficientFunds() && canJoinTournament() && (
            <div className="flex items-center space-x-2 text-xs text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-2 rounded-lg">
              ...
              <span>
                Need {formatMoney(tournament.entry_fee - user.wallet_balance, tournamentCurrency)} more
              </span>
            </div>
          )}
        </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-700 dark:text-red-400 mt-0.5">
                        You need {formatMoney(
                          tournament.entry_fee - user.wallet_balance,
                          tournamentCurrency
                        )} more
                      </p>
                    </div>
