...
const JoinTournamentCard = ({ tournament, user, onJoinClick }) => {
  ...
  return (
    <div className="bg-neutral-800 rounded-lg shadow p-4 sm:p-6">
      <h2 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Join Tournament</h2>
      
      {isUserParticipant() ? (
        <div className="text-center">
          <p className="text-green-400 text-sm sm:text-base mb-3 sm:mb-4">You've already joined this tournament!</p>
          <button
            disabled
        ...
        <div className="text-center">
          <p className="text-red-400 text-sm sm:text-base mb-3 sm:mb-4">This tournament is full.</p>
          <button
            disabled
            className="w-full bg-gray-600 text-gray-400 py-2 px-4 rounded-md cursor-not-allowed text-sm sm:text-base"
          >
        ...
        <div className="text-center">
          <p className="text-red-400 text-sm sm:text-base mb-3 sm:mb-4">This tournament has already started.</p>
          <button
            disabled
            className="w-full bg-gray-600 text-gray-400 py-2 px-4 rounded-md cursor-not-allowed text-sm sm:text-base"
          >
        ...
        <div>
          ...
          {parseFloat(user.wallet_balance || 0) < parseFloat(tournament.entry_fee) ? (
            <div className="text-center">
              <p className="text-red-400 text-sm sm:text-base mb-3">Insufficient funds to join this tournament.</p>
