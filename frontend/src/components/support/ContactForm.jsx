  ...
  return (
    <div className="bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 rounded-xl p-4 sm:p-6 lg:sticky lg:top-8">
      <div className="mb-4 sm:mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2">Contact Support</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg border bg-neutral-900 py-2.5 sm:py-3 px-3 sm:px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors text-sm sm:text-base ${
                formErrors.name 
        ...
        <div>
          ...
          <select
            ...
            onChange={handleInputChange}
            className="w-full rounded-lg border border-neutral-600 bg-neutral-900 py-2.5 sm:py-3 px-3 sm:px-4 text-white focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-colors text-sm sm:text-base"
          >
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className={`w-full rounded-lg border bg-neutral-900 py-2.5 sm:py-3 px-3 sm:px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors resize-none text-sm sm:text-base ${
              formErrors.message 
                ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' 
                : 'border-neutral-600 focus:border-blue-500 focus:ring-blue-500/20'
            }`}
      ...
      <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-neutral-700">
        <h3 className="text-white font-semibold mb-3 text-sm sm:text-base">Support Information</h3>
